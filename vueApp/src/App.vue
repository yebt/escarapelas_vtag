...
const changeBrowserTheme = () => {
  browserTheme.value = browserTheme.value === 'dark' ? 'light' : 'dark'
  document.documentElement.dataset.theme = browserTheme.value
}
  ...
  <main class="container" >
    <nav>
      ...
      <ul>
        <li>
          <!-- theem toggle -->
          <a href="#" @click.prevent="changeBrowserTheme" class="secondary">

            <svg v-if="browserTheme === 'dark'" xmlns="http://www.w3.org/2000/svg"
            ...
            <svg v-else xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-moon" width="24" height="24"
    ...
    <article>
      ...
      <div style="aspect-ratio: 1.33;width: 100%;">
        <qrcode-stream class="qrcode-stream" @detect="onDetect" :constraints="{ facingMode }" :torch="light"
          :formats="['qr_code']" :track="paintCenterText" :paused="pauseStatus" @camera-on="onCameraOn" @error="onError">
